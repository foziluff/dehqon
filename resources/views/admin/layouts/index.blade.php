    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
            ...
            <ul class="menu-inner py-1 overflow-auto">
                ...
                <!-- Перечень удобрений -->
                <li class="menu-item {{ Request::segment(2) === 'fertilizers' ? 'active' : '' }}">
                    <a href="{{ route('fertilizers.index') }}" class="menu-link">
                ...
                <!-- Агрокредиты -->
                <li class="menu-item {{ Request::segment(2) === 'agro-credits' ? 'active' : '' }}">
                    <a href="{{ route('agroCredits.index') }}" class="menu-link">
