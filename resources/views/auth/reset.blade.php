        ...
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form  id="formAuthentication"  class="mb-3" action="{{ route('sendCode') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="phone"  class="form-label">Номер телефона (992XXXXXXXXX)</label>
                            <input type="text" placeholder="992XXXXXXXXX" class="form-control" name="phone" id="phone" value="{{ old('phone') }}">
                        </div>
