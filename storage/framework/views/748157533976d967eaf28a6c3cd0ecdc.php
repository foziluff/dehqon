...
<?php $__env->startSection('content'); ?>
    <div class="col">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <a href="<?php echo e(route('protectiveEquipments.protectiveEquipmentItems', $record->id)); ?>" type="button" class="btn btn-outline-secondary mr-1">Items</a>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/dehqon/resources/views/admin/protectiveEquipment/show.blade.php ENDPATH**/ ?>