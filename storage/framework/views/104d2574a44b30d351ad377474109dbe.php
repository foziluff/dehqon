...
<div class="card" style="margin: 50px auto; border-radius: 30px; padding: 0px 30px; box-shadow: 0 0 30px -20px;">
    <div class="card-body">
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('deleteAccount.destroy')); ?>" method="POST" class="w-75 align-items-center mx-auto d-flex" style="flex-direction: column; justify-content: center" >
            <?php echo csrf_field(); ?>
            <p>Удалите аккаунт тут:</p>
            <input type="text" class="form-control" style="width: 80%" name="phone" value="<?php echo e(old('phone')); ?>" style="font-size: 16px;" placeholder="992XXXXXXXXX">
