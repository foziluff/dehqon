                    ...
                    <tr>
                        ...
                        <td>
                            <a class="td-title" href="<?php echo e(route($module . '.show', $record->id)); ?>">
                                <span class="fw-medium"><?php echo e($record->productType->title); ?> - <?php echo e($record->price); ?></span>
                            </a>
                        </td>
                        <td class="text-right">
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dehqon\resources\views\admin\conversion\consumption\index.blade.php ENDPATH**/ ?>