        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <div class="form-control"><?php echo e($record->consumptionCategory->title); ?></div>
                </div>

                <div class="mt-3">
                    <label class="form-label">Операция</label>
                    <div class="form-control"><?php echo e($record->consumptionOperation->title); ?></div>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <div class="form-control"><?php echo e($record->consumptionNaming->title); ?></div>
                </div>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dehqon\resources\views\admin\field\consumption\show.blade.php ENDPATH**/ ?>