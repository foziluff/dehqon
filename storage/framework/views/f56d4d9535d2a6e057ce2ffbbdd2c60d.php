        ...
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form  id="formAuthentication"  class="mb-3" action="<?php echo e(route('sendCode')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="phone"  class="form-label">Номер телефона (992XXXXXXXXX)</label>
                            <input type="text" placeholder="992XXXXXXXXX" class="form-control" name="phone" id="phone" value="<?php echo e(old('phone')); ?>">
                        </div>
...
<?php /**PATH C:\xampp\htdocs\dehqon\resources\views/auth/reset.blade.php ENDPATH**/ ?>