        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <div class="form-control"><?php echo e($record->fuelType->title); ?></div>
                </div>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dehqon\resources\views\admin\field\show.blade.php ENDPATH**/ ?>