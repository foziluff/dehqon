            ...
            <div class="card-body">
                <form action="<?php echo e(route($module . '.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea name="description_ru" class="form-control" placeholder="Описание" rows="3"><?php echo e(old('description_ru')); ?></textarea>
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Описание (UZ)</label>
                        <textarea name="description_uz" class="form-control" placeholder="Описание" rows="3"><?php echo e(old('description_uz')); ?></textarea>
                    </div>
                    <div class="mt-3">
                        <label class="form-label">Описание (TJ)</label>
                        <textarea name="description_tj" class="form-control" placeholder="Описание" rows="3"><?php echo e(old('description_tj')); ?></textarea>
                    </div>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/dehqon/resources/views/admin/agroCredit/create.blade.php ENDPATH**/ ?>