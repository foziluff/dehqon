        ...
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="formAuthentication" class="mb-3" action="<?php echo e(route('verifyCode')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="code" class="form-label">Введите код</label>
                            <input type="hidden" name="phone" value="<?php if(session('phone')): ?><?php echo e(session('phone')); ?><?php endif; ?>">
                            <input maxlength="4"
...
<?php /**PATH C:\xampp\htdocs\dehqon\resources\views/auth/verify.blade.php ENDPATH**/ ?>